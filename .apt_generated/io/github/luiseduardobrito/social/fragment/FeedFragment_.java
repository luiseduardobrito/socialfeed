    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public static FeedFragment_.FragmentBuilder_ builder() {
        return new FeedFragment_.FragmentBuilder_();
    }
    ...
    public void toastError(final String message) {
        handler_.post(new Runnable() {
            ...
            @Override
            public void run() {
                FeedFragment_.super.toastError(message);
            }
    ...
    public void refreshAdapter() {
        handler_.post(new Runnable() {
            ...
            @Override
            public void run() {
                FeedFragment_.super.refreshAdapter();
            }
